...
<Title>Github</Title>
<Description>
  Using the github provider let you use the github oauth2 flow to authenticate
  users.
</Description>

# GithubStrategy

Using the github provider let you use the github oauth2 flow to authenticate users.
