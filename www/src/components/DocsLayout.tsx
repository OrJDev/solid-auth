...
export function DocsLayout(props: DocsLayoutProps) {
  ...
  const getNavIndex = createMemo(() => getNavItems().indexOf(location.pathname))
      ...
      <div class='relative flex-1 py-12 md:py-20 lg:w-px lg:py-32 lg:pl-9'>
        ...
        <div class='mt-10 flex justify-between px-8 md:mt-12 lg:mt-14 lg:px-10'>
          ...
          <IconButton
            variant='secondary'
            type='link'
            href={`https://github.com/orjdev/solid-auth/blob/main/www/src/routes${location.pathname}.mdx`}
            target='_blank'
            label='Edit page'
            icon={PenIcon}
          />
